...
public abstract class View : UserControl
{
    ...
    protected View()
    {
        ...
        DependencyPropertyDescriptor.FromProperty(DataContextProperty, typeof(View)).AddValueChanged(this, OnDataConteextChanged);
    }

    void OnDataConteextChanged(object? sender, EventArgs e)
    {
